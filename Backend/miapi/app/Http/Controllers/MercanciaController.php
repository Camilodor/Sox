...
class MercanciaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Seguimiento::create([
            ...
            'usuario_id' => $mercancia->usuario_id, // Asumiendo que el controlador tiene acceso a los datos de usuario
    ...
    public function update(Request $request, $id)
    {
        ...
        Seguimiento::create([
            ...
            'usuario_id' => $mercancia->usuario_id, // Suponiendo que el controlador tiene acceso a los datos de usuario
            'mercancia_id' => $mercancia->id
        ]);
