...
class MercanciaFormActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Fecha: DatePicker para etFechaM
        etFechaM.isFocusable = false
        etFechaM.isClickable = true
        etFechaM.setOnClickListener {
            ...
            android.app.DatePickerDialog(this, { _, y, m, d ->
                ...
                etFechaM.setText(formattedDate)
            }, year, month, day).show()
        }
        ...
        mercanciaExistente?.let {
            ...
            etFechaM.setText(it.fecha_ingreso) // Ya se mostrará en YYYY-MM-DD si viene del backend
        ...
        btnGuardar.setOnClickListener {
            ...
            val nuevaMercancia = Mercancias(
                ...
                fecha_ingreso = etFechaM.text.toString(), // ✅ siempre YYYY-MM-DD
            ...
            if (mercanciaExistente == null) {
                ...
                nuevaMercancia.id?.let {
                    api.updateMercancia(it, nuevaMercancia).enqueue(callbackConMensaje("Mercancía actualizada"))
                }
            }
        }
    }
